...
-- 1. Create ScreenType enum (missing from initial migration)
CREATE TYPE IF NOT EXISTS "ScreenType" AS ENUM ('STANDARD_2D', 'THREE_D', 'SCREENX');
...
-- 4. Add TWINSEAT to SeatType enum (PostgreSQL doesn't support IF NOT EXISTS for enum values)
ALTER TYPE "SeatType" ADD VALUE IF NOT EXISTS 'TWINSEAT';
